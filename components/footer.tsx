    ...
    <>
      <div className="w-full bg-black text-[#FAFAFA] md:h-[400px]">
        <div className="flex flex-col md:flex-row flex-wrap">
          <div className="w-full md:w-1/4	flex flex-col justify-center h-80  p-10">
          ...
          <div className="w-full md:w-1/4	flex flex-col text-center justify-center h-80  p-10">
          ...
          <div className="w-full md:w-1/4	flex flex-col justify-center h-80  p-6">
